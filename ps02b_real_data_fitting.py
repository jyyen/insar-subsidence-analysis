#!/usr/bin/env python3
"""
InSAR Real Data Signal Fitting and Component Analysis
Focus on real Taiwan InSAR time series with minimal synthetic examples

This script demonstrates:
1. Fitting parametric models to real InSAR observations
2. Component decomposition of actual subsidence signals
3. Realistic performance on Taiwan groundwater subsidence data
"""
