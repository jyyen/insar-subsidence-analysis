#!/usr/bin/env python3
"""
PS02C-PyTorch Spatial Regularization Framework
Phase 1 Implementation: Spatial neighbor integration for improved signal correlation

Key Enhancements:
1. ✅ Spatial neighbor graph using sklearn
2. ✅ Spatial consistency loss for seasonal patterns
3. ✅ EMD-informed parameter initialization
4. ✅ Borehole geological constraints
5. ✅ Multi-method integration framework

Target: Signal correlation 0.065 → 0.3-0.5 (5-8x improvement)
