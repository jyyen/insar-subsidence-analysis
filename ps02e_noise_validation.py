"""
PS02E - Noise Model Validation on New Stations

This script:
1. Loads the learned spatial noise model from ps02c
2. Selects a different set of random stations
3. Generates synthetic InSAR data with realistic spatially-correlated noise
4. Tests if signal extraction methods can recover true parameters
5. Compares performance with/without spatial noise

Key validation metrics:
- Parameter recovery accuracy
- RMSE improvement with noise-aware methods
- Spatial patterns in fitting errors
