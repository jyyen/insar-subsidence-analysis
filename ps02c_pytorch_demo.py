#!/usr/bin/env python3
"""
PS02C-PyTorch Demonstration Script
Demonstrates the new PyTorch-based InSAR signal fitting framework

This script shows:
1. Loading Taiwan InSAR data
2. Training the PyTorch model on subset of stations  
3. Comparing with PS00 GPS-corrected rates
4. Visualizing results for extreme subsiding/uplifting sites
5. Performance comparison with existing PS02C methods
