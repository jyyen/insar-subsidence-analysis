        ...
        def plot_station_comparison(ax, station_global_idx, title_prefix, color):
            ...
            if len(ps02c_pos) > 0:
                ...
                if fitted_params:
                    ...
                    # ROLLBACK: If wrong, change fitted_rate back to positive: trend_fitted = fitted_rate * time_years
                    trend_original = -original_rate * time_years  # FIX: PS00 rates need sign flip for visualization
                    trend_fitted = -fitted_rate * time_years      # FIX: PS02C also uses PS00 rates, needs same sign flip
                    ...
                    trend_original = -original_rate * time_years  # FIX: PS00 needs sign flip
