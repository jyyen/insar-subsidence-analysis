#!/usr/bin/env python3
"""
PS02C-PyTorch Optimal Framework
Hybrid approach: Excellent rate fitting + Good seasonal correlation + Fixed offsets

Strategy:
1. Constrain linear trends to PS00 rates (preserve 0.999 rate correlation)
2. Add offset correction for vertical alignment
3. Focus optimization on seasonal components only
4. Use targeted loss function weighting

Expected Results:
- Rate Correlation: ~0.999 (maintained)
- Signal Correlation: >0.5 (target)
- Vertical Offsets: Fixed
- RMSE: <20mm (target)
