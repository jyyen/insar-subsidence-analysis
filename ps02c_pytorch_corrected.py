#!/usr/bin/env python3
"""
PS02C-PyTorch Corrected Framework
Fixed sign convention and enhanced visualization

CRITICAL FIXES:
1. ✅ InSAR Sign Convention: Negative = Subsidence, Positive = Uplift
2. ✅ Rainbow colormap for asymmetric subsidence range (-48 to +37 mm/year)
3. ✅ Proper trend line calculation and display
4. ✅ Geographic subsidence rate visualization
