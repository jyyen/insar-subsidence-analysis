#!/usr/bin/env python3
"""
PS02C-PyTorch Geographic Analysis
Enhanced visualization with geographic subsidence rate distribution and trend analysis

New Features:
1. Geographic map of fitted subsidence rates
2. Time series plots with trend lines (observed vs fitted)
3. Rate difference analysis (PS00 vs PyTorch)
4. Spatial correlation analysis
5. Comprehensive trend decomposition visualization
